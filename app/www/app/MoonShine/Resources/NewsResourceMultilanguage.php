...
class NewsResourceMultilanguage extends ModelResource implements \MoonShine\Contracts\Menu\MenuFiller
{
...
//                            ->required()
                    ...
                    Tab::make('EN*', [
                        Text::make('Title', 'title->en')
                            ->setValue($this->getItem()?->getTranslation('title', 'en'))
                            ->required()
                            ->hideOnIndex(),
                        TinyMce::make('Content', 'content->en')
                            ->setValue($this->getItem()?->getTranslation('content', 'en'))
//                            ->required()
                            ->hideOnIndex(),
                        Slug::make('Slug', 'slug->en')
                            ->setValue($this->getItem()?->getTranslation('slug', 'en'))
                            ->separator('-')
                            ->required()
                            ->hideOnIndex(),
                    ])
...
//                HasManyThrough::make('Tag', resource: new TagsResource())
//                    ->relationship(MorphToMany::class)
//                    ->hideOnIndex(),
            Divider::make(),
            Block::make([
                Image::make('Thumbnail', 'thumbnail')->hideOnIndex(),
            ])
        ];
    }
