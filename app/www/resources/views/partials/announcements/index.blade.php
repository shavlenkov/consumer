...
@section('content')
    <div class="container custom-container post-container">
        <div class="row">
            <div class="col-12">
                {{ Breadcrumbs::render('announcements.index', $announcements) }}

            </div>
            <div class="col-12">
                <div class="announcements-list posts-list">
                    <div class="post-item">
                        @foreach($announcements as $announcement)
                            <h3><a href="{{ route('announcements.show', $announcement->id) }}">{{ $announcement->title }}</a></h3>
